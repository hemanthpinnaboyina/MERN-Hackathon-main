...
export default function PlaceOrder() {
	...
	const handlePlaceOrder = () => {
		if (cart.length === 0) return; // Prevent placing order if cart is empty
		// Generate random orderId and status
		...
		// Optionally, remove items from context
		cart.forEach((_, i) => removeFromCart(0));
		// After a short delay, navigate to Orders page
